...
| --- | --- | --- | --- |
| `architecture.md` | `- **APPROVED**: intent is within policy. A signed Intent Attestation is issued immediately.` | gate-decision | Retain during Wave 1; replace after the emitter flip in the Wave 4 sweep. |
